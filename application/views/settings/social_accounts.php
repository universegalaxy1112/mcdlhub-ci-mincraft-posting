            ...
            <div class="col-sm-12 col-md-9">
                <div class="row-custom">
                    <div class="profile-tab-content">
                        ...
                        <?php echo form_open("social-accounts-post"); ?>
                        ...
                        <div class="form-group">
                            <label class="control-label">Twitch <?php echo trans('url'); ?></label>
                            <input type="text" class="form-control form-input" name="instagram_url" placeholder="Twitch <?php echo trans('url'); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-input" name="telegram_url"
                                   placeholder="Telegram <?php /*echo trans('url'); */?>" value="<?php /*echo html_escape($user->telegram_url); */?>" <?php /*echo ($this->rtl == true) ? 'dir="rtl"' : ''; */?>>
                        </div>
