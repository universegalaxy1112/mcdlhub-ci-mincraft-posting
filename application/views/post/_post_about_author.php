        ...
        <div class="row">
            ...
            <div class="about-author">
                <div class="about-author-left">
                    <a href="<?php echo generate_profile_url($post_user->slug); ?>" class="author-link">
                        <img src="<?php echo get_user_avatar($post_user->avatar); ?>" alt="" class="img-responsive img-author">
                    </a>
                </div>
                <div class="about-author-right">
                    <div class="about-author-row">
                        <p>
                            <strong>
                                <a href="<?php echo generate_profile_url($post_user->slug); ?>" class="author-link"> <?php echo html_escape($post_user->username); ?> </a>
                            </strong>
                        </p>
                    </div>
