            ...
            <div class="col-sm-12 mobile-nav-buttons">
                <?php if ($this->auth_check) :
                    if (check_user_permission('add_post')): ?>
                        <a href="https://mcdlhub.com/admin/add-post?type=article" class="btn btn-custom btn-mobile-nav btn-mobile-nav-add close-menu-click" ><i class="icon-copy"></i><?php echo trans("add_post"); ?></a>
                    <?php endif; ?>
                <?php else:
