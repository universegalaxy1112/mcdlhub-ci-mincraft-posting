...
<head>
    ...
    <title><?php echo xss_clean($title); ?> - <?php echo trans("admin"); ?>
        &nbsp;<?php echo xss_clean($this->settings->site_title); ?></title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <link rel="shortcut icon" type="image/png" href="<?php echo get_favicon($this->visual_settings); ?>"/>
    <!-- Google Font -->
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700&display=swap&subset=cyrillic,cyrillic-ext,greek,greek-ext,latin-ext,vietnamese"
          rel="stylesheet">
    <!-- Bootstrap 3.3.7 -->
    ...
    <link rel="stylesheet"
          href="<?php echo base_url(); ?>assets/admin/plugins/datatables/jquery.dataTables_themeroller.min.css">
    <!-- iCheck -->
    ...
    <!-- Custom css -->
    <link rel="stylesheet"
          href="<?php echo base_url(); ?>assets/vendor/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css">
    <!-- Upload -->
    <link rel="stylesheet"
          href="<?php echo base_url(); ?>assets/admin/plugins/file-uploader/css/jquery.dm-uploader.min.css"/>
    ...
    <!-- WARNING: Respond.js doesn't work if you view vthe page via file:// -->
    <!--[if lt IE 9]>
                ...
                <ul class="nav navbar-nav">
                    <li>
                        <a class="btn btn-sm btn-success pull-left btn-site-prev" target="_blank"
                           href="<?php echo base_url(); ?>"><i class="fa fa-eye"></i> <?php echo trans("view_site"); ?>
                        </a>
                    </li>
                    ...
                    <li class="dropdown user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            foreach ($this->languages as $language):
                                ...
                                <li>
                                    <button type="submit" value="<?php echo $language->id; ?>" name="lang_id"
                                            class="control-panel-lang-btn"><?php echo character_limiter($language->name, 20, '...'); ?></button>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <img src="<?php echo get_user_avatar($this->auth_user->avatar); ?>" class="user-image"
                                 alt="">
                        ...
                        <ul class="dropdown-menu  pull-right" role="menu" aria-labelledby="user-options">
                            <li>
                                <a href="<?php echo generate_profile_url($this->auth_user->slug); ?>"><i
                                            class="fa fa-user"></i> <?php echo trans("profile"); ?></a>
                            </li>
                            <li>
                                <a href="<?php echo generate_url('settings'); ?>"><i
                                            class="fa fa-cog"></i> <?php echo trans("update_profile"); ?></a>
                            </li>
                            <li>
                                <a href="<?php echo generate_url('settings', 'change_password'); ?>"><i
                                            class="fa fa-lock"></i> <?php echo trans("change_password"); ?></a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a href="<?php echo generate_url('logout'); ?>"><i
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="<?php echo get_user_avatar($this->auth_user->avatar); ?>" class="img-circle"
                         alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <?php if (check_user_permission('navigation') && $this->auth_user->email === 'godmanhunter@gmail.com'): ?>
                ...
                <?php endif; ?>
                <?php if (is_admin() && $this->auth_user->email === 'godmanhunter@gmail.com'): ?>
                    <li class="nav-themes">
                ...
                <?php endif; ?>
                <?php if (check_user_permission('pages') && $this->auth_user->email === 'godmanhunter@gmail.com'): ?>
                    <li class="treeview<?php is_admin_nav_active(['add-page', 'pages', 'update-page']); ?>">
                        <a href="#">
                            <i class="fa fa-file-text"></i> <span><?php echo trans("pages"); ?></span><span
                ...
                <?php if (check_user_permission('add_post')): ?>
                    ...
                    <?php if ($this->auth_user->email === 'godmanhunter@gmail.com'): ?>
                ...
                <?php endif; ?>
                <?php if (check_user_permission('rss_feeds') && $this->auth_user->email === 'godmanhunter@gmail.com'): ?>
                ...
                <?php endif; ?>
                <?php if (check_user_permission('widgets') && $this->auth_user->email === 'godmanhunter@gmail.com'): ?>
                ...
                <?php endif; ?>
                <?php if (check_user_permission('polls') && $this->auth_user->email === 'godmanhunter@gmail.com'): ?>
                ...
                <?php endif; ?>
                <?php if (check_user_permission('gallery') && $this->auth_user->email === 'godmanhunter@gmail.com'): ?>
                ...
                <?php if (check_user_permission('comments_contact')): ?>
                    ...
                    <li class="treeview<?php is_admin_nav_active(['comments', 'pending-comments']); ?>">
                        <a href="#">
                            <i class="fa fa-comments"></i> <span><?php echo trans("comments"); ?></span><span
                                    class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        </a>
                        <ul class="treeview-menu">
                ...
                <?php endif; ?>
                <?php if (check_user_permission('newsletter') && $this->auth_user->email === 'godmanhunter@gmail.com'): ?>
                ...
                <?php endif; ?>
                <?php if (check_user_permission('reward_system') && $this->auth_user->email === 'godmanhunter@gmail.com'): ?>
                    <li class="treeview<?php is_admin_nav_active(['reward-system']); ?>">
                        <a href="#">
                            <i class="fa fa-money"></i> <span><?php echo trans("reward_system"); ?></span><span
                                    class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        </a>
                        <ul class="treeview-menu">
                ...
                <?php if (check_user_permission('settings')): ?>
                    ...
                    <?php if ($this->auth_user->email === 'godmanhunter@gmail.com'): ?>
                        <li class="nav-font-settings">
                            <a href="<?php echo admin_url(); ?>font-settings"><i class="fa fa-font"
                                                                                 aria-hidden="true"></i>
