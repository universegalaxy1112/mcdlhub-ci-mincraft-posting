        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="visual-color-box" data-color="default" style="background-color: #1abc9c;"><?php echo ($this->site_color === "default") ? '<i class="fa fa-check"></i>' : ""; ?></div>
                            <div class="visual-color-box" data-color="violet" style="background-color: #6770B7;"><?php echo ($this->site_color === "violet") ? '<i class="fa fa-check"></i>' : ""; ?></div>
                            <div class="visual-color-box" data-color="blue" style="background-color: #1da7da;"><?php echo ($this->site_color === "blue") ? '<i class="fa fa-check"></i>' : ""; ?></div>
                            <div class="visual-color-box" data-color="bondi" style="background-color: #0494b1;"><?php echo ($this->site_color === "bondi") ? '<i class="fa fa-check"></i>' : ""; ?></div>
                            <div class="visual-color-box" data-color="amaranth" style="background-color: #e91e63;"><?php echo ($this->site_color === "amaranth") ? '<i class="fa fa-check"></i>' : ""; ?></div>
                            <div class="visual-color-box" data-color="red" style="background-color: #e74c3c;"><?php echo ($this->site_color === "red") ? '<i class="fa fa-check"></i>' : ""; ?></div>
                            <div class="visual-color-box" data-color="orange" style="background-color: #f86923;"><?php echo ($this->site_color === "orange") ? '<i class="fa fa-check"></i>' : ""; ?></div>
                            <div class="visual-color-box" data-color="yellow" style="background-color: #f2d438;"><?php echo ($this->site_color === "yellow") ? '<i class="fa fa-check"></i>' : ""; ?></div>
                            <div class="visual-color-box" data-color="bluewood" style="background-color: #34495e;"><?php echo ($this->site_color === "bluewood") ? '<i class="fa fa-check"></i>' : ""; ?></div>
                            <div class="visual-color-box" data-color="cascade" style="background-color: #95a5a6;"><?php echo ($this->site_color === "cascade") ? '<i class="fa fa-check"></i>' : ""; ?></div>
