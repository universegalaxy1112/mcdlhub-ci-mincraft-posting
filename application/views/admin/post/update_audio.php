    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12 form-header">
                <h1 class="form-title"><?php echo trans('update_audio'); ?></h1>
                ...
                <div class="form-post">
                    ...
                    <div class="form-post-right">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <?php $this->load->view('admin/post/_upload_audio_box'); ?>
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <?php $this->load->view('admin/post/_publish_box', ['post_type' => 'audio']); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $this->load->view('admin/file-manager/_load_file_manager', ['load_images' => true, 'load_files' => true, 'load_videos' => false, 'load_audios' => true]); ?>
<style>
    .content-wrapper {
