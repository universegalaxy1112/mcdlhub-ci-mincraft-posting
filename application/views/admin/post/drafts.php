                    ...
                    <table class="table table-bordered table-striped" role="grid">
                        ...
                        <?php foreach ($posts as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <?php $lang = get_language($item->lang_id);
                                    if (!empty($lang)) {
                                        ...
                                        <ul class="dropdown-menu options-dropdown">
                                            <li>
                                                <button type="submit" name="option" value="publish_draft" class="btn-list-button">
                                                    <i class="fa fa-location-arrow option-icon" aria-hidden="true"></i><?php echo trans('publish'); ?>
                                                </button>
                                            </li>
                                            <li>
                        ...
                        <div class="row">
                            ...
                            <?php if (count($posts) > 0): ?>
                                <div class="pull-left bulk-options">
                                    ...
                                    <button class="btn btn-sm btn-default btn-table-delete" onclick="post_bulk_options('publish_draft');"><i class="fa fa-location-arrow option-icon"></i><?php echo trans('publish'); ?></button>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
