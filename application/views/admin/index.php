...
<?php if (check_user_permission('admin_panel') && is_admin()): ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box admin-small-box bg-danger">
                <div class="inner">
                    <h3 class="increase-count"><?php echo $total_post_views; ?></h3>
                    <a href="<?php echo admin_url(); ?>posts">
                        <p><?php echo trans("total_post_views"); ?></p>
                    </a>
                </div>
                <div class="icon">
                            ...
                            <table class="table no-margin">
                                ...
                                <?php foreach ($last_contacts as $item): ?>
                                    <tr>
                                        ...
                                        <td style="min-width: 16%" class="nowrap">
                            ...
                            <?php foreach ($last_users as $item) : ?>
                                <li>
                                    <a href="<?php echo generate_profile_url($item->slug); ?>">
                                        <img src="<?php echo get_user_avatar($item->avatar); ?>" alt="user" class="img-responsive">
                                    </a>
