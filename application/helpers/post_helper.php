    ...
    function get_popular_posts($date_type, $lang_id)
    {
        ...
        if ($date_type == "week") {
            ...
            if (empty($popular_posts)) {
                $popular_posts = complete_popular_posts($ci->post_model->get_popular_posts_weekly($lang_id), $lang_id);
            ...
            if (empty($popular_posts)) {
                $popular_posts = complete_popular_posts($ci->post_model->get_popular_posts_monthly($lang_id), $lang_id);
...
if (!function_exists('complete_popular_posts')) {
    function complete_popular_posts($popular_posts, $lang_id)
    {
        ...
        $latest_posts = $ci->post_model->get_latest_category_posts($lang_id);
        if (!empty($latest_posts)) {
