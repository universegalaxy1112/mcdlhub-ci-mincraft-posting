...
class Gallery_controller extends Admin_Core_Controller
{
    ...
    public function gallery_images()
    {
        ...
        //paginate
        $pagination = $this->paginate(admin_url() . 'gallery-images', $this->gallery_model->get_paginated_images_count());
        $data['images'] = $this->gallery_model->get_paginated_images($pagination['per_page'], $pagination['offset']);
    ...
    public function add_image()
    {
        ...
        $this->load->view('admin/includes/_header', $data);
        $this->load->view('admin/gallery/add_image', $data);
        $this->load->view('admin/includes/_footer');
    }
    ...
    public function update_gallery_image($id)
    {
        ...
        $this->load->view('admin/includes/_header', $data);
        $this->load->view('admin/gallery/update_image', $data);
        $this->load->view('admin/includes/_footer');
    }
    ...
    public function gallery_albums()
    {
        ...
        $data['albums'] = $this->gallery_category_model->get_albums();
        $data['panel_settings'] = panel_settings();
