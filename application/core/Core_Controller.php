...
class Core_Controller extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->total_post_views = $this->post_admin_model->get_total_post_views();
        $this->users_count = $this->profile_model->get_users_count();
        $this->post_count = $this->post_admin_model->get_posts_count();
    }
