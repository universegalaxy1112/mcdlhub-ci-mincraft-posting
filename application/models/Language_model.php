...
class Language_model extends CI_Model
{
    ...
    public function add_language_rows($lang_id)
    {
        ...
        $settings = array(
            ...
            'home_title' => "Index",
            'site_description' => "Minecraft",
            'keywords' => "minecraft, mods, maps, servers, skins, texture packs, seends",
    ...
    public function add_language_pages($lang_id)
    {
        //add pages
        $page = array(
            'lang_id' => $lang_id, 'title' => "Gallery", 'slug' => "gallery", 'description' => "Mcdlhub Gallery Page", 'keywords' => "Mcdlhub, gallery , page", 'is_custom' => 0, 'page_default_name' => 'gallery', 'page_content' => "", 'page_order' => 2, 'visibility' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => "main", 'link' => '', 'parent_id' => 0, 'page_type' => "page",
        );
        $this->db->insert('pages', $page);
        $page = array(
            'lang_id' => $lang_id, 'title' => "Contact", 'slug' => "contact", 'description' => "Mcdlhub Contact Page", 'keywords' => "Mcdlhub, contact, page", 'is_custom' => 0, 'page_default_name' => 'contact', 'page_content' => "", 'page_order' => 1, 'visibility' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => "top", 'link' => '', 'parent_id' => 0, 'page_type' => "page",
        );
        $this->db->insert('pages', $page);

        $page = array(
            'lang_id' => $lang_id, 'title' => "Terms & Conditions", 'slug' => "terms-conditions", 'description' => "Mcdlhub Terms Conditions Page", 'keywords' => "Mcdlhub, terms, conditions", 'is_custom' => 0, 'page_default_name' => 'terms_conditions', 'page_content' => "", 'page_order' => 1, 'visibility' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => "footer", 'link' => '', 'parent_id' => 0, 'page_type' => "page",
        );
        $this->db->insert('pages', $page);
    }
