...
class Settings_model extends CI_Model
{
    ...
    public function update_settings()
    {
        $general = array(
            ...
            'cookie_prefix' => $this->input->post('cookie_prefix', true),
    ...
    public function update_route_settings()
    {
        $data = array(
            ...
            'delete_account' => $this->input->post('delete_account', true),
            ...
            'payouts' => $this->input->post('payouts', true),
            'set_payout_account' => $this->input->post('set_payout_account', true),
    ...
    public function update_preferences($form)
    {
        if ($form == 'general') {
            $data = array(
                ...
                'show_user_email_on_profile' => $this->input->post('show_user_email_on_profile', true),
            ...
            $data = array(
                ...
                'show_latest_posts_on_slider' => $this->input->post('show_latest_posts_on_slider', true),
                'show_latest_posts_on_featured' => $this->input->post('show_latest_posts_on_featured', true),
