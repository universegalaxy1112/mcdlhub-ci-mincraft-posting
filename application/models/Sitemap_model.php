...
class Sitemap_model extends CI_Model
{
    public function __construct()
    {
        parent::__construct();
        $this->urls = array();
        $this->posts_limit = 30000;
        $this->tags_limit = 10000;
    }
    ...
    public function get_categories()
    {
        ...
        $this->db->select('categories.*, languages.short_form AS lang_short_form');
        $this->db->where('languages.status', 1);
    ...
    public function get_posts()
    {
        ...
        $this->db->limit($this->posts_limit);
