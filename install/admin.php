...
if (isset($_POST["btn_admin"])) {
    ...
    if (mysqli_connect_errno()) {
        ...
        mysqli_query($connection, "INSERT INTO users (id, username, slug, email, email_status, token, password, role, user_type, status, show_email_on_profile, show_rss_feeds) VALUES (1, '" . $admin_username . "', '" . $slug . "', '" . $admin_email . "',1 ,'" . $token . "', '" . $password . "', 'admin', 'registered', 1, 1, 1)");
        mysqli_query($connection, "UPDATE general_settings SET vr_key='" . $license_code . "', purchase_code='" . $purchase_code . "', timezone='" . $timezone . "', cookie_prefix='" . $cookie_prefix . "' WHERE id='1'");
